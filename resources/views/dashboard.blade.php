        ...
        <div class="app-section space-y-6">
            ...
            <div class="dashboard-summary-grid">
                <section class="app-card p-5">
                    ...
                    <p class="mt-3 text-3xl font-semibold text-gray-900">{{ $patientSyncAppointmentsCount }}</p>
                    <p class="mt-1 text-xs font-semibold text-muted">{{ now()->translatedFormat('l d F') }} - solo calendari pazienti</p>
                </section>
